...
it enables developers to configure their local environments to reflect mainnet conditions more accurately.`
	...
	cmd.Example = fmt.Sprintf(`%sd in-place-testnet testing-1 norynthvaloper1w7f3xx7e75p4l7qdym5msqem9rd4dyc4mq79dm --home $HOME/.%sd/validator1 --validator-privkey=6dq+/KHNvyiw2TToCgOpUpQKIzrLs69Rb8Az39xvmxPHNoPxY1Cil8FY+4DhT9YwD6s0tFABMlLcpaylzKKBOg== --accounts-to-fund="norynth1f7twgcq4ypzg7y24wuywy06xmdet8pc4473tnq,norynth1qvuhm5m644660nd8377d6l7yz9e9hhm9evmx3x"`, "norynth", "norynth")
