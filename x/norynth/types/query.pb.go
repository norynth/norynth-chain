...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1886f02c0400eda6, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1886f02c0400eda6, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "norynth.norynth.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "norynth.norynth.QueryParamsResponse")
}

func init() { proto.RegisterFile("norynth/norynth/query.proto", fileDescriptor_1886f02c0400eda6) }

var fileDescriptor_1886f02c0400eda6 = []byte{
	// 292 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xce, 0xcb, 0x2f, 0xaa,
	0xcc, 0x2b, 0xc9, 0xd0, 0x87, 0xd1, 0x85, 0xa5, 0xa9, 0x45, 0x95, 0x7a, 0x05, 0x45, 0xf9, 0x25,
	...
	0x9c, 0xc4, 0x06, 0x0e, 0x21, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x75, 0x1f, 0x36, 0xb3,
	0xe2, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/norynth.norynth.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/norynth.norynth.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "norynth.norynth.Query",
	...
	Metadata: "norynth/norynth/query.proto",
}
